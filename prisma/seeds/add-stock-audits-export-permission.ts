// prisma/seeds/add-stock-audits-export-permission.ts
//
// Mục đích: CHỈ thêm (upsert) đúng MỘT quyền `stock_audits:export` vào bảng
...
//
// Cách chạy:  yarn seed:stock-audits-export
//
...
async function main() {
  console.log(
    '🌱 Thêm quyền stock_audits:export (chỉ 1 quyền, không ảnh hưởng dữ liệu khác)...',
  );
...
main()
  ...
  .catch((e) => {
    console.error('❌ Lỗi khi thêm quyền stock_audits:export:', e);
    process.exit(1);
  })
