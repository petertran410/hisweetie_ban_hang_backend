// prisma/seeds/add-order-suppliers-export-permission.ts
//
// Mục đích: CHỈ thêm (upsert) đúng MỘT quyền `order_suppliers:export` vào bảng
...
//
// Cách chạy:  yarn seed:order-suppliers-export
//
...
async function main() {
  console.log(
    '🌱 Thêm quyền order_suppliers:export (chỉ 1 quyền, không ảnh hưởng dữ liệu khác)...',
  );
...
main()
  ...
  .catch((e) => {
    console.error('❌ Lỗi khi thêm quyền order_suppliers:export:', e);
    process.exit(1);
  })
