// prisma/seeds/add-productions-export-permission.ts
//
// Mục đích: CHỈ thêm (upsert) đúng MỘT quyền `productions:export` vào bảng
...
//
// Cách chạy:  yarn seed:productions-export
//
...
async function main() {
  console.log(
    '🌱 Thêm quyền productions:export (chỉ 1 quyền, không ảnh hưởng dữ liệu khác)...',
  );
...
main()
  ...
  .catch((e) => {
    console.error('❌ Lỗi khi thêm quyền productions:export:', e);
    process.exit(1);
  })
